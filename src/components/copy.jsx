    ...
    <div className="w-full min-h-screen bg-[var(--bg-secondary)] flex justify-center items-center py-16 px-4">
      <div className="max-w-screen-xl mx-auto w-full space-y-10">
        ...
        <div className="text-center space-y-3">
          <h1 className="text-[var(--font-primary)] text-3xl md:text-4xl lg:text-4xl font-bold">
            Featured Projects
          </h1>
          <p className="text-[var(--font-secondary)] text-base md:text-lg max-w-3xl mx-auto">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow space-y-4">
                ...
                {/* Tech Stack */}
                <div className="font-bold text-[var(--font-primary)] flex flex-wrap gap-3">
        ...
        >
          {" "}
          <h1 className="text-center text-[var(--font-primary)] cursor-pointer">
            See All Projects
          </h1>
        </a>
      </div>
