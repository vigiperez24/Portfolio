...
function Contactme() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_k6wtnok", // ✅ Service ID
        "template_crvpud", // ✅ Template ID
        {
          name: formData.name,
          email: formData.email,
          message: formData.message,
        },
        "clYGp3IlWRqQP4wvj" // ✅ Public key
      )
      .then(
        (result) => {
  ...
  return (
    <div
      className="w-full flex justify-center items-start py-16 px-5"
      ...
      <div className="max-w-screen-xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <EnvelopeIcon />
              <span>vigiperez2324@gmail.com</span>
            </a>
            ...
            >
              <FacebookIcon />
              <span>https://www.facebook.com/vigiperez</span>
            </a>
            ...
            >
              <GithubIcon />
              <span>https://github.com/vigiperez24</span>
            </a>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="juancarlo@example.com"
                  required
                />
              </div>
